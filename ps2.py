...
if(play==1):
    ...
    print("Player1 turn")
    print("palyer 1 can add [1,3,5,7,9] numbers only")
    print("palyer 2 can add [2,4,6,8] numbers only")
elif(play==2):
    play1=Cloning(list2)
    play2=Cloning(list1)           # cloning the list to player
    print("player2 turn")
    print("palyer 2 can add [1,3,5,7,9] numbers only")
    print("palyer 1 can add [2,4,6,8] numbers only")
else:
    print("wrong choice")
while(21):
    # print(play1)
